...
namespace IronPdf.Aspire.AI.ServiceDefaults
{
    ...
    public static class PdfGeneratorExtensions
    {
        ...
        public static IHostApplicationBuilder AddPdfGenerator(this IHostApplicationBuilder builder, string ConnectionName)
        {

            // Connection information for the IronPDF engine
            var ironUri = builder.Configuration.GetConnectionString(ConnectionName);
